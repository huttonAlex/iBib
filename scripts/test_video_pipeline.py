...
class PARSeqOCR:
    ...
    def predict_batch_detailed(self, crops_bgr):
        import numpy as np
        import cv2
        ...
        for i in range(len(crops_bgr)):
            ...
            digits_text = ""
            digit_details = []
            # Walk through decoded text, tracking position in the prob sequence
            # PARSeq tokenizer output starts after BOS token (position 1+)
            ...
            for ch in text:
                ...
                if ch.isdigit():
                    ...
                    # Runner-up among digit tokens only
                    ...
                    digit_details.append(DigitDetail(
                        digit=ch,
                        prob=top_prob,
            ...
            results.append(DetailedOCRResult(
                text=digits_text,
